...
char errorMsg[MAX_BUFFER] = "error";
char okMsg[MAX_BUFFER] = "ok";
char studentList[MAX_BUFFER];
char accsList[MAX_BUFFER];
char examsList[MAX_BUFFER];
char groupList[MAX_BUFFER];
char studGroupList[MAX_BUFFER];
char rightAnswersExam[MAX_BUFFER];
char studResult[MAX_BUFFER];
//CLIENT&SERVER:
int socketCreate (int socketType)
{
    int socketId;
